...
public class ListUtilsTest {
    ...
    public void whenAddAfterLast() {
        ...
        assertThat(input, Is.is(Arrays.asList(0, 1, 2, 3, 4, 5, 6)));
    }

    @Test
    public void whenRemoveIf() {
        List<Integer> input = new ArrayList<>(Arrays.asList(0, 1, 2, 3, 4, 5));
        ListUtils.removeIf(input, i -> i.intValue() > 3);
    ...
    public void whenReplaceIf() {
        List<Integer> input = new ArrayList<>(Arrays.asList(0, 1, 2, 3, 4, 5));
        ListUtils.replaceIf(input, i -> i.intValue() > 3, 8);
        assertThat(input, Is.is(Arrays.asList(0, 1, 2, 3, 8, 8)));
    }
    ...
    public void removeAllIf() {
        ...
        assertThat(input, Is.is(Arrays.asList(0, 2, 4)));
    }
}
